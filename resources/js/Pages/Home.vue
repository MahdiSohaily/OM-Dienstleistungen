...
<template>
    ...
    <Header :title="props.main_page.title" :title_desc="props.main_page.title_desc"
        :mail_to_title="props.main_page.mail_to_title" :social_title="props.main_page.social_title"
        :mail_to="company.email_address" />
    <section class="py-5">
        <div class="container">
            <div class="row">
